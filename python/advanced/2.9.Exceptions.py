...
try:
    ...
    print "handling key error"
    print ke.message                  # message is a field of ke which contains the error message
                                      # in the case of KeyErrors the error message is the key which caused the error
...
try:
    ...
    print err.message                   # Q. what will this print?
...
try:
    ...
    print e                     # str(e) is the error message
