...
''' OUTPUT (14.Extra/ExerciseX-REVIEW-B.py):
...
DATA
    ...
    defpath = ':/bin:/usr/bin'
    devnull = '/dev/null'
    environ = environ({'XPC_SERVICE_NAME': '0', 'rvm_bin_path'...3FE147870...
    environb = environ({b'XPC_SERVICE_NAME': b'0', b'rvm_bin_pa...E147870E...
    extsep = '.'
    linesep = '\n'
    name = 'posix'
    pardir = '..'
