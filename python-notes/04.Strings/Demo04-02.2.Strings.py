...
# A. at the end of the print statement the comma suppresses the final \n usually output
...
print('{0[name]} {0[profession]}'.format(person))
...
''' OUTPUT (04.Strings/Demo04-02.2.Strings.py):
michael
michael burgess
hello world
michael
...
excpet... "it is easier to use the other kind inside" 
...
['username:michael', 'email:michael.burgess@qa.com']
michael
sherlock, mycroft, watson
mycroft
--------------------
...
be the change you wish to see in the room
be the best
i hate  the change you wish to see in the world!
!dlrow eht ni ees ot hsiw uoy egnahc eht eb
be the change you wish to see in the world!
True
2
It begins with hell
this string is just whitespace
HELLO WORLD
hello world
hello world
goodbye world
