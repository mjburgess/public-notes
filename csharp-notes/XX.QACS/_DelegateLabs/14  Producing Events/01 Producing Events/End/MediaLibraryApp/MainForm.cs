...
namespace MediaLibraryApp
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            loginControl1.Login += (o, e) => this.BackColor = Color.LightGreen;
            loginControl1.Login += (o, e) => tssLoginStatus.Text = string.Format("{0} logged in", e.Username);
        }

        //void loginControl1_Login(object sender, LoginEventArgs e)
        //{
        //    this.BackColor = Color.LightGreen;
        //    tssLoginStatus.Text = string.Format("{0} logged in", e.Username);
        //}
