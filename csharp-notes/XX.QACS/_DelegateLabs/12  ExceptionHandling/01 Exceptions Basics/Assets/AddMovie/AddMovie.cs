...
namespace MediaLibraryApp {
    public partial class AddMovie : Form {
        ...
        private void btnOK_Click(object sender, EventArgs e) {
            ...
            Rating rating;
            bool isRated = Enum.TryParse(cboRating.Text, out rating); // TODO 3 rating text not one of the enums?
        ...
        private void btnSelect_Click(object sender, EventArgs e) {
            ...
            ofd.ShowDialog();  // TODO 4 what if the user cancels out of the OpenFileDialog?

            FileInfo fiSelected = new FileInfo(ofd.FileName);
            fiSelected.CopyTo(Path.Combine("images", fiSelected.Name)); // TODO 5 what if the user selects a file from the images folder so 'copy to yourself'?
