...
namespace MediaLibraryApp
{
    public partial class MainForm : Form
    {
        ...
        {
            MediaItem currentItem = myMediaLibrary[currentItemIndex];  // TODO what if library has no entries ?
        ...
        {
            Sound.Initialize(new SetLevelsDel(SetLevels));
            Sound.Initialize(delegate(double bassBoost)
            {
                tbBassBoost.Value = (int)bassBoost;
            });
        }
        private void SetLevels(double bassBoost)
        {
            tbBassBoost.Value = (int)bassBoost;
        }
        ...
        // TODO closing app whilst a delegate is running
    }
